...
<html>
	...
	<body>	
		...
		<div class="container">
			<div class="row mt-4">
				<div class="col">
					<h1>Archieve Table...!</h1>
					<a href="register.php" class="btn btn-primary float-right mb-4">Register first</a>
					<a href="view.php" class="btn btn-success float-right mr-3">View Table</a>
						...
						<?php 
							...
							while ($data = $result->fetch_object()) {
								echo "<tr>";
									...
									echo "<td>";
										echo "<a href='recover.php?recoverId=$data->id' class='btn btn-success btn-sm'> Recover</a> ";
